...
import com.ctrip.sqllin.driver.NativeDatabasePath
...
internal class SQLiteDatabase(private val dbPointer: CPointer<sqlite3>) {


}

internal fun openNativeDatabase(configuration: DatabaseConfiguration): SQLiteDatabase {
    val sqliteFlags = if (configuration.isReadOnly)
    ...
    val db = memScoped {
        ...
        val openResult = sqlite3_open_v2((configuration.path as NativeDatabasePath).pathString, dbPtr.ptr, sqliteFlags, null)
